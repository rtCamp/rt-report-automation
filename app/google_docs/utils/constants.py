...
MAX_FOLDER_ID_LENGTH = 255  # Maximum length to prevent ReDoS attacks
MIN_DOC_ID_LENGTH = 8  # Minimum length for valid Google Docs document IDs
MAX_DOC_ID_LENGTH = 255  # Maximum length to prevent ReDoS attacks
